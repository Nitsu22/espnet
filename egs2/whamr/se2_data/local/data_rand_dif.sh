...
local/whamr_create_mixture_rand_dif.sh --mono ${mono} --min-or-max ${min_or_max} --sample-rate ${sample_rate} \
...
local/whamr_data_prep_rand.sh --min-or-max ${min_or_max} --sample-rate ${sample_rate} \
