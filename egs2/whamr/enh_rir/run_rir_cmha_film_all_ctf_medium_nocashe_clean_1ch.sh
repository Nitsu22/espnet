...
CUDA_VISIBLE_DEVICES=${gpu} ./enh_rir.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_medium_nocashe_rir_cmha_film_all_ctf.yaml \
    --enh_args "--batch_size 8 --accum_grad 1 --seed 0" \
    --expdir "${expdir}" \
    --enh_exp "${expdir}/enh_train_enh_tflocoformer_medium_nocashe_rir_cmha_film_all_ctf_clean_1ch" \
