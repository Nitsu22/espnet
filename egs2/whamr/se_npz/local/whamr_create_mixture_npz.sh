...
# Require create_wham_from_scratch_npz.py and configure it
if [ ! -f "${dir}/whamr_scripts/create_wham_from_scratch_npz.py" ]; then
  echo "Error: ${dir}/whamr_scripts/create_wham_from_scratch_npz.py not found."
  exit 1
fi
...
echo "Log is in ${dir}/whamr_scripts/mix_npz.log"
