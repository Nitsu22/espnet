...
CUDA_VISIBLE_DEVICES=0 ./enh_se_condition_ablation.sh \
    --train_set "${train_set}" \
    --valid_set "${valid_set}" \
    --test_sets "${test_sets}" \
    --fs ${sample_rate} \
    ...
    --enh_config ./conf/tuning/ttrain_enh_tflocoformer_nocashe_se_aeaall_cold_lr3_resnet_256_small_film.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_nocashe_se_aeafusion_cold_lr3_resnet_256_4gpu_small_film2 \
...
# bash run_eval_ablation_small_cold_film2.sh --ablation_mode oracle
# bash run_eval_ablation_small_cold_film2.sh --ablation_mode swap_rir
# bash run_eval_ablation_small_cold_film2.sh --ablation_mode swap_audio
# bash run_eval_ablation_small_cold_film2.sh --ablation_mode rand_sample
# bash run_eval_ablation_small_cold_film2.sh --ablation_mode mean
