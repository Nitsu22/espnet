...
CUDA_VISIBLE_DEVICES=0 ./enh_se_condition_ablation.sh \
    ...
    --enh_exp exp/enh_train_enh_tflocoformer_nocashe_se_aeafusion_cold_lr3_resnet_256_4gpu_small_film3 \
...
# bash run_eval_ablation_small_cold_film3.sh --ablation_mode oracle
# bash run_eval_ablation_small_cold_film3.sh --ablation_mode swap_rir
# bash run_eval_ablation_small_cold_film3.sh --ablation_mode swap_audio
# bash run_eval_ablation_small_cold_film3.sh --ablation_mode rand_sample
# bash run_eval_ablation_small_cold_film3.sh --ablation_mode mean
