...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./enh_se_condition.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_nocashe_se_aeafirst_film_cold_lr3_resnet.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_nocashe_se_aeafusion_film_first_cold_lr3_resnet_4gpu \
