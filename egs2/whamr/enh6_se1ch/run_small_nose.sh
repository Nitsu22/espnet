...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./enh_se_condition.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_nocashe_se_aeaall_cold_lr3_lr4_resnet_256_small_nose.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_nocashe_se_aeafusion_cold_lr3_lr4_resnet_256_4gpu_small_nose \
