...
CUDA_VISIBLE_DEVICES=0 ./enh_se_condition_ablation.sh \
    ...
    --enh_config ./conf/tuning/ttrain_enh_tflocoformer_nocashe_se_aeaall_cold_lr3_resnet_256_small.yaml \
...
# bash run_eval_ablation_small_cold.sh --ablation_mode oracle
# bash run_eval_ablation_small_cold.sh --ablation_mode swap_rir
# bash run_eval_ablation_small_cold.sh --ablation_mode swap_audio
# bash run_eval_ablation_small_cold.sh --ablation_mode rand_sample
# bash run_eval_ablation_small_cold.sh --ablation_mode mean
