...
### - Normal data (data and dump) already exist
### - whamr_scripts, wham_noise, wsj_full_wav already exist
### - WSJ transcriptions (other_text, nlsyms) already exist
### Only generates and prepares reverse speaker position data (reverbse and anechoic_reverse)
...
# Prepare reverse speaker position data (reverbse and anechoic_reverse)
# The following datasets will be created:
# {tr,cv,tt}_mix_{both,clean}_reverb_{reverbse,anechoic_reverse}_${min_or_max}_${sample_rate}
