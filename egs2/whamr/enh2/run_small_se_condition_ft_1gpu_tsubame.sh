...
CUDA_VISIBLE_DEVICES=0 ./enh_se_condition.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_small_se_condition_ft_tsubame.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_small_se_condition_ft_1gpu_tsubame \
