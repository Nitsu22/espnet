...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./enh_se_condition.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_nocache_small_se_condition_dif_div_cold.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_nocache_small_se_condition_cold_4gpu_hydrogen \
