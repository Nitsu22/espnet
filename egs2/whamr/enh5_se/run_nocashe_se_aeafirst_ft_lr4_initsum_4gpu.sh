...
CUDA_VISIBLE_DEVICES=0,1,2,3 ./enh_se_condition.sh \
    ...
    --enh_config ./conf/tuning/train_enh_tflocoformer_nocashe_se_aeafirst_ft_lr4.yaml \
    --enh_exp exp/enh_train_enh_tflocoformer_nocashe_se_aeafirst_ft_lr4_initsum_4gpu \
