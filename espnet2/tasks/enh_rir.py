...
from espnet2.enh.espnet_model_rir import ESPnetEnhancementRIRModel
...
from espnet2.enh.separator.tflocoformer_separator_nocashe_rir_cmha import (
    TFLocoformerSeparator as TFLocoformerSeparatorNocasheRIRCMHA,
)
from espnet2.enh.separator.tflocoformer_separator_nocashe_rir_cmha_all import (
    TFLocoformerSeparator as TFLocoformerSeparatorNocasheRIRCMHAAll,
)
...
from espnet2.enh.separator.tflocoformer_separator_nocashe_rir_tempomha import (
    TFLocoformerSeparator as TFLocoformerSeparatorNocasheRIRTempOMHA,
)
...
from espnet2.train.preprocessor_enh_rir import EnhRIRPreprocessor
...
separator_choices = ClassChoices(
    ...
    classes=dict(
        ...
        tflocoformer_nocashe_rir_cmha=TFLocoformerSeparatorNocasheRIRCMHA,
        tflocoformer_nocashe_rir_cmha_all=TFLocoformerSeparatorNocasheRIRCMHAAll,
        tflocoformer_nocashe_rir_cmha_film_first=(
            TFLocoformerSeparatorNocasheRIRCMHAFiLMFirst
        ),
...
class EnhancementRIRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetEnhancementRIRModel),
    ...
    def build_preprocess_fn(
        ...
        if use_preprocessor:
            ...
            elif args.preprocessor in ("enh", "enh_rir"):
                kwargs = dict(
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetEnhancementRIRModel:
        ...
        if getattr(args, "diffusion_model", None) is not None:
            ...
            model = ESPnetEnhancementRIRModel(
                encoder=encoder,
                separator=separator,
                decoder=decoder,
