...
from espnet2.enh.espnet_model_se_condition_mc_conformer import ESPnetEnhancementModel
...
from espnet2.enh.separator.tflocoformer_separator_nocashe_se_condition_mc_conformer import (
    TFLocoformerSeparatorSECondition as TFLocoformerSeparatorSEConditionMCConformer,
)
...
from espnet2.enh_se.spatial_encoder.resnet2d_div_spatial_encoder import ResNet2DDivSpatialEncoder
...
from espnet2.train.preprocessor_add import EnhPreprocessorPlus
...
separator_choices = ClassChoices(
    ...
    classes=dict(
        ...
        tflocoformer_sp_nocache_mc_conformer=TFLocoformerSeparatorSEConditionMCConformer,
    ),
...
class EnhancementTask(AbsTask):
    ...
    def build_preprocess_fn(
        ...
        if use_preprocessor:
            ...
            elif args.preprocessor in ("enh", "enh_plus"):
                kwargs = dict(
    ...
    def optional_data_names(
        ...
        retval = ["speech_mix", "speech_mix_mc"]
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetEnhancementModel:
        ...
        if getattr(args, "spatial_encoder", None) is not None:
            ...
            # mc_conformer は embed_dim、resnet2d 系は embedding_dim
