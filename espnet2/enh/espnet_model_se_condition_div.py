...
class ESPnetEnhancementModel(AbsESPnetModel):
    ...
    def __init__(
        ...
        Args:
            ...
            spatial_encoder: spatial encoder module that processes single-channel features
                to extract spatial embeddings (e.g., MCConformerDivSpatialEncoder)
            spatial_encoder_encoder: encoder used to compute spatial encoder inputs
                from single-channel waveforms (e.g., STFTEncoder)
    ...
    def forward_enhance(
        ...
        feature_mix_sc, flens_sc = self.spatial_encoder_encoder(
            speech_mix, speech_lengths, fs=fs
        )
