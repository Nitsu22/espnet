...
class TFLocoformerSeparator(AbsSeparator):
    ...
    Args:
        ...
        use_spatial_encoder: bool
            If False, skip spatial embedding FiLM and behave like
    ...
    def __init__(
        ...
        # Apply FiLM conditioning once right after self.conv.
        self.film_block = FiLM(
            embed_dim=spatial_embed_dim,
            feature_dim=emb_dim,
        )
        self.film_block.init_identity()
    ...
    def forward(
        ...
        if self.use_spatial_encoder:
            batch = self.film_block(spatial_emb, batch)  # [B, emb_dim, T, F]
